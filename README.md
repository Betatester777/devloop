...
| Release Manager | Orchestrator asks version number, audience, migration | Auto-increment minor version |
...
Skills are reusable procedures referenced by agents from their definition files.
...
│   ├── STATE.md            # Current phase, sub-phase, and YOLO mode flag
│   ├── input/              # User request capture
│   │   └── user_request.md
...
└── .claude/
    ├── commands/           # Slash commands (/devloop-start, etc.)
